...
export default function HIMSPage() {
  ...
  return (
    <>
      ...
      <section className=" p-20 relative min-h-screen flex items-center bg-gradient-to-br from-blue-50 via-white to-blue-100 pt-28 overflow-hidden">
        ...
        <div className="relative max-w-7xl mx-auto px-6 grid lg:grid-cols-2 gap-20 items-center">
          ...
          <div>
            ...
            <p className="text-lg text-white/85 max-w-xl mb-10">
              ...
              enhance patient care through intelligent digital healthcare
              systems.
            </p>
      ...
      {/* ================= CTA ================= */}
      <section
        className="relative pt-40 pb-24 md:pt-52 md:pb-28
  bg-gradient-to-r from-[#023042] via-[#053C50] to-[#04748B]
  text-white overflow-hidden"
      >
        {/* Glow accents */}
        <div className="absolute -top-32 -left-32 w-96 h-96 bg-[#C85038]/30 rounded-full blur-3xl" />
        <div className="absolute bottom-0 -right-32 w-96 h-96 bg-[#9C4436]/20 rounded-full blur-3xl" />

        <div className="relative max-w-5xl mx-auto px-6 text-center">
          <span
            className="inline-block mb-6 px-5 py-2 text-sm font-semibold
      bg-white/15 backdrop-blur-md rounded-full"
          ...
          <div className="flex flex-wrap justify-center gap-6">
            <button
              className="bg-[#C85038] px-12 py-4 rounded-2xl font-semibold
        shadow-2xl hover:bg-[#9C4436] hover:scale-105 transition"
            >
              Book Free Demo
            </button>

            <button
              className="border-2 border-[#] px-12 py-4 rounded-2xl font-semibold
        hover:bg-[#C85038] hover:text-white transition"
            >
              Talk to Expert
            </button>
          </div>
